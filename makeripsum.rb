...
#   b. a Twitter API that returns tweets from @MakerSquare and #makeripsum
# 2. Paragraphs are generated by selcting strings randomly from the dictionary
# 3. Tweet normalization
#   a. "@xxxx" and "#xxxx" strings are pulled out of tweet, where x is a
#       string of characters
#   b. leading spaces are removed
#   c. trailing spaces are removed
# 4. Hard-coded (yikes!!!) parameters are set as follows
#   a. number of sentences per paragraph: rand(10..12)
#   b. number words per sentence: rand(10,15)
# 5. punctuation/capitalize
#   a. First word of sentences are capitalized
#   b. Sentences ending puncuation picked randomly from %w{. ! ?}
#   c. Sentences contain 2 (Hard-coded, bummer!) middle punctuation
